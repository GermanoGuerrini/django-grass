...
if 'test' in sys.argv:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'grasstest',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '9s2-yppp890vdvt*u!lu75xd5woro#&i10x(i*a*onr1wvnc#='
...
MIGRATION_MODULES = {'grass': 'grass.no_migrations_here'}
